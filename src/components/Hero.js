...
const Hero = () => {
  ...
  const roles = ['Full Stack Developer', 'Web Developer', 'Software Engineer', 'Problem Solver'];
      ...
      <div className="container">
        <div className="hero-content">
          <div className="hero-text">
            <div className="welcome-badge fade-in">
              ⭐ Welcome to my portfolio
            </div>
            
            <h1 className="hero-title slide-in-left">
              Hello, 👋<br />
              I'm <span className="name-highlight">Your Name</span>
            </h1>
            ...
            <p className="hero-description fade-in">
              Web developer passionate about building modern full-stack applications 
              using cutting-edge technologies. I create seamless digital experiences 
